    ...
    visa: [
      {
        ...
        answer: "Most nationalities require a visa to enter Egypt. We assist with medical visa applications, which often have expedited processing. Tourist visas are also acceptable for medical tourism. We provide detailed guidance based on your nationality.",
      },
      {
      ...
      },
      {
        ...
        answer: "Tourist visas typically allow 30-day stays with possible extensions. Medical visas can accommodate longer treatment periods. We help coordinate visa duration with your treatment timeline and recovery needs.",
      },
      {
        question: "Do you provide airport pickup and assistance?",
        answer: "Yes, we offer complimentary airport pickup and drop-off services. Our team will meet you at Cairo International Airport and assist with all arrival procedures, including transportation to your accommodation or hospital.",
      },
    ],
    treatments: [
      {
        question: "What medical specialties are available?",
        answer: "We offer comprehensive medical services including cardiac surgery, orthopedics, cosmetic surgery, dental care, oncology, neurosurgery, fertility treatments, bariatric surgery, ophthalmology (LASIK), and organ transplants.",
      },
      {
        question: "How do I choose the right doctor for my treatment?",
        answer: "Our medical coordinators will match you with specialists based on your condition, preferred treatment approach, and doctor qualifications. You can review doctor profiles, credentials, and patient testimonials before making your decision.",
      },
      {
      ...
      },
      {
        ...
        answer: "Treatment timelines vary by procedure. Simple treatments may require 3-7 days, while complex surgeries might need 2-4 weeks including recovery. We provide detailed timelines during your consultation and help plan accordingly.",
      },
    ],
    costs: [
      {
        question: "How much can I save compared to treatment in my home country?",
        answer: "Patients typically save 50-70% compared to US/European prices while receiving the same quality of care. For example, a heart bypass surgery costing $100,000+ in the US might cost $15,000-25,000 in Egypt, including accommodation and care.",
      },
      {
        question: "What is included in the treatment package?",
        answer: "Our packages include medical consultation, treatment/surgery, hospital stay, medications, follow-up visits, airport transfers, and medical coordination. Accommodation and additional services can be added based on your preferences.",
      },
      {
        question: "What payment methods do you accept?",
        answer: "We accept bank transfers, credit cards (Visa, MasterCard), and cash payments. Payment plans can be arranged for complex treatments. We provide detailed cost breakdowns and transparent pricing with no hidden fees.",
      },
      {
        question: "Will my insurance cover treatment in Egypt?",
        answer: "Some international insurance plans cover overseas medical treatment. We assist with insurance documentation and pre-authorization requests. Even with travel costs, many patients find significant savings compared to domestic treatment.",
      },
    ],
    accommodation: [
      {
      ...
      },
      {
        ...
        answer: "Yes, we encourage family support during your medical journey. We can arrange accommodation for companions and provide guidance on their visa requirements. Many of our partner hotels offer family-friendly amenities.",
      },
      {
        question: "How is transportation handled during my stay?",
        answer: "We provide comprehensive transportation including airport transfers, hospital visits, and local sightseeing if your recovery allows. Our vehicles are comfortable and our drivers are experienced with medical tourism requirements.",
      },
      {
        question: "What amenities are available at your partner accommodations?",
        answer: "Our accommodations feature WiFi, 24/7 room service, medical-friendly amenities, proximity to hospitals, and comfortable environments for recovery. Many offer special services for medical tourists including nurse visits and dietary accommodations.",
      },
    ],
    aftercare: [
      {
        question: "What follow-up care is provided after treatment?",
        answer: "We provide comprehensive aftercare including post-operative check-ups, medication management, physical therapy if needed, and coordination with your home country physicians for ongoing care. Our support continues after you return home.",
      },
      {
        question: "How do you coordinate care with my doctor at home?",
        answer: "We provide detailed medical reports, imaging results, and treatment summaries to your home physicians. Our doctors can consult directly with your local healthcare team to ensure seamless care transition.",
      },
      {
        question: "What if complications arise after I return home?",
        answer: "Our doctors remain available for consultation after your return. We maintain communication channels and can provide guidance to your local physicians. In rare cases requiring additional treatment, we assist with return arrangements.",
      },
      {
    ...
    emergency: [
      {
        ...
        answer: "Our medical coordinators are available 24/7 for emergencies. We have direct connections to all partner hospitals and can arrange immediate medical attention. Emergency contact numbers are provided to all patients.",
      },
      {
      ...
      },
      {
        ...
        answer: "We have established protocols for medical emergencies including immediate hospital access, specialist consultations, family notification procedures, and coordination with embassies if needed. Your safety is our top priority.",
      },
      {
        question: "What if I need to return home urgently?",
        answer: "We assist with emergency travel arrangements including medical clearance for travel, escort services if needed, and coordination with airlines for medical accommodations. We work with international medical assistance companies when required.",
      },
    ],
  };
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Our medical coordinators are available 24/7 to provide personalized answers to your specific questions.
          </p>
