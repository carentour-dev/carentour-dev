  ...
  return (
    <div className="space-y-8">
      <WorkspacePageHeader
        breadcrumb="Admin"
        title="Patients"
        subtitle="Maintain traveler records, emergency contacts, and preferences to streamline concierge coordination."
        actions={
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-2">
                    ...
                    <FormDescription className="text-xs">
                      Bypass the verification flow for this patient&apos;s email
                      address.
                    </FormDescription>
                  </FormItem>
                )}
