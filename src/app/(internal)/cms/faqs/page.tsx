    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardFooter className="flex flex-wrap items-center gap-3">
          <FaqFormDialog
            ...
            trigger={
              <Button size="sm" className="gap-2" disabled={isArabicLocale}>
      ...
      <Card>
        <CardHeader className="space-y-2 border-none bg-transparent pb-0">
          ...
          <CardDescription>
            {isArabicLocale
              ? "Edit Arabic titles, descriptions, and publish state for existing FAQ categories."
              : "Manage FAQ categories available for assignment. Categories in use cannot be deleted."}
          </CardDescription>
        </CardHeader>
