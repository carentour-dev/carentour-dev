  ...
  const accommodationCards = useMemo(() => {
    if (hotels.length === 0) {
      return fallbackAccommodationOptions.map((option) => ({
        ...
        icon: option.type.includes("Apartment")
          ? Building
          : option.type.includes("Resort")
            ? Palmtree
            : Hotel,
    ...
    return hotels.map((hotel) => {
      ...
      return {
        ...
        description:
          hotel.description ??
          "Partner accommodation close to medical service providers.",
        ...
        locationLabel:
          location ||
          (typeof hotel.distance_to_facility_km === "number"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Everything you need to know about traveling to Egypt for medical
                treatment, from visa requirements to accommodation options and
                local information.
              </p>
            </div>
          </div>
            ...
            <Tabs defaultValue="visa" className="max-w-6xl mx-auto">
              ...
              <TabsContent value="visa" className="space-y-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Simple visa process for medical tourists with multiple
                    convenient options
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <ul className="space-y-2">
                        ...
                        <li className="flex items-center gap-2">
                          <Check className="h-4 w-4 text-primary" />
                          <span className="text-sm">
                            Extension: Possible for medical treatment
                          </span>
                        </li>
                      </ul>
                  ...
                  <Card className="border-border/50">
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-muted-foreground">
                        Quick visa processing directly at Cairo International
                        Airport.
                      </p>
                      <ul className="space-y-2">
                        <li className="flex items-center gap-2">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 text-sm text-muted-foreground">
                          ...
                          <li>
                            • Medical visa extensions available for extended
                            treatment
                          </li>
                          <li>
                          ...
                          <li>
                            • COVID-19 requirements may apply - check current
                            regulations
                          </li>
                        </ul>
                      </div>
              ...
              <TabsContent value="accommodation" className="space-y-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Comfortable and convenient lodging options tailored for
                    medical tourists
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                  <div>
                    ...
                    <Card className="border-border/50">
                      ...
                      <CardContent className="space-y-4">
                        <p className="text-muted-foreground">
                          We handle all accommodation arrangements based on your
                          medical schedule and budget preferences.
                        </p>
                        <ul className="space-y-2">
                          <li className="flex items-center gap-2">
                  ...
                  <div className="space-y-6">
                    ...
                    {hotelsError ? (
                      <Card className="border-border/50">
                        <CardContent className="py-6 text-center text-sm text-muted-foreground">
                          Showing sample accommodation options while partner
                          data loads.
                        </CardContent>
                      </Card>
                    ) : null}
              ...
              <TabsContent value="egypt-info" className="space-y-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Essential information about Egypt&apos;s climate, culture,
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {egyptInfo.currency.name}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {egyptInfo.currency.exchange}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {egyptInfo.currency.cards}
                        </p>
                      </div>
                      <div>
                        <h5 className="font-semibold text-sm mb-1">Cash</h5>
                        <p className="text-sm text-muted-foreground">
                          {egyptInfo.currency.cash}
                        </p>
                      </div>
                    </CardContent>
                  </Card>
              ...
              <TabsContent value="practical" className="space-y-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Transportation, communication, and other practical details
                    for your medical tourism journey
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <Card className="border-border/50">
                  ...
                  <Card className="border-border/50">
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Free WiFi in hotels, hospitals, and most cafes
                        </p>
                      </div>
                      <div>
                        <h5 className="font-semibold text-sm mb-1">
                ...
                <Card className="border-border/50 bg-gradient-card">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                      Our travel coordination team is here to help with all
                      aspects of your journey to Egypt. From visa assistance to
                      local arrangements, we&apos;ve got you covered.
                    </p>
