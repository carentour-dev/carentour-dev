...
async function getSeo(cmsPage: CmsPage | null) {
  const title =
    ...
    cmsPage.seo.title.trim().length > 0
      ...
      : "About Care N Tour | Medical Tourism Experts";
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      ...
                      patients seeking world-class treatment abroad and guide
                      them through a seamless journey from consultation to
                      recovery.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      provide care that is tailored to each patient&apos;s
                      needs. Our role includes helping patients choose the right
                      doctors, providing support for travel and accommodation
                      arrangements, and providing follow-up support. Every
                      detail is handled with precision and compassion.
                    </p>
                    <p>
                      ...
                      appointments. This often led to unclear pricing,
                      fragmented services, and a stressful experience. Care N
                      Tour brings everything together in one trusted place,
                      offering verified medical providers, transparent treatment
                      packages, integrated travel arrangements, and dedicated
                      case management.
                    </p>
                    <div>
                      ...
                      <ul className="list-disc pl-5 space-y-2">
                        <li>
                          Carefully selected and verified medical partners
                        </li>
                        <li>
                          Complete end-to-end coordination supported by
                          technology
                        </li>
                    ...
                    <p>
                      ...
                      transparent, and worry-free. By combining medical
                      expertise with personal guidance, we help patients and
                      their families feel supported before, during, and after
                      treatment.
                    </p>
                    <p>
                      At Care N Tour, we are not just coordinators. We are
                      partners in your health journey. Our mission is to help
                      you access safe, advanced, and affordable treatment in
                      Egypt. Our vision is to be leaders in the medical tourism
                      industry and to help position the country as the trusted
                      go-to global destination for high-quality healthcare.
                    </p>
                    <p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-muted-foreground leading-relaxed space-y-3">
                      <p>
                        ...
                        the world to premium and accessible medical care in
                        Egypt. We connect them with trusted doctors and
                        accredited hospitals, while coordinating travel,
                        accommodation, and follow-up in a simple and supportive
                        way.
                      </p>
                      <p>
                        Our mission is to create a safe and smooth medical
                        journey that feels personal, well-organized, and
                        reassuring. With a team that understands healthcare,
                        digital services, and patient needs, we work to make
                        every step clear, comfortable, and truly empowering.
                      </p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    ...
                    <div className="text-muted-foreground leading-relaxed space-y-3">
                      <p>
                        ...
                        global destination for high-quality healthcare. We aim
                        to offer exceptional patient experiences through
                        verified medical partners, clear and honest information,
                        and thoughtful, concierge-style support.
                      </p>
                      <p>
                        By combining strong medical expertise and cutting-edge
                        digital innovation with reliable coordination and a
                        personal touch, we hope to become the most trusted
                        partner for people seeking world-class treatment in
                        Egypt.
                      </p>
                    </div>
                  </div>
