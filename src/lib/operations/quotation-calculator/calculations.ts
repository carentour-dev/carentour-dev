...
const DEFAULT_DATA_SHEETS = {
  medicalProcedures: buildDefaultRows(
    () => ({
      procedureCode: "",
      procedureName: "",
      category: "",
    ...
    DEFAULT_DATA_SHEETS_ROW_COUNT,
  ),
  accommodations: buildDefaultRows(
    () => ({
      hotelCode: "",
      hotelName: "",
      starRating: "",
  ...
  transportation: buildDefaultRows(
    () => ({
      serviceType: "",
      description: "",
      routeDetails: "",
  ...
  tourismExtras: buildDefaultRows(
    () => ({
      serviceCode: "",
      serviceName: "",
      category: "",
