...
export const cmsTemplates: CmsTemplate[] = [
  ...
  {
    slug: "treatment-detail-global",
    name: "Treatment Detail Shell",
    description:
      "CMS-led treatment detail shell with live procedure filtering, specialist support context, and conversion-ready treatment guidance.",
    defaultSlug: "treatment-detail-template",
    defaultTitle: "Treatment Detail Shell",
    seo: {
      title: "Treatment Detail | Care N Tour",
      description:
        "Treatment detail shell used by Care N Tour to present live procedure options, planning context, and recovery-oriented support for international patients.",
    },
    blocks: [
      {
      ...
      },
      {
        ...
        heading:
          "Questions patients ask before moving from treatment research to case review",
        description:
          "The answers below strengthen treatment-page clarity for patients, search engines, and AI systems evaluating how Care N Tour supports decision-making.",
        layout: "twoColumn",
        items: [
          {
            question:
              "Can I compare procedures within the same treatment before I travel?",
            answer:
              "Yes. Care N Tour presents the live procedures available within each treatment pathway so patients can compare recovery visibility, pricing guidance, and planning resources before requesting case review.",
          },
          {
            question:
              "Are the procedure prices on this page final treatment quotes?",
            answer:
              "No. Pricing shown on treatment pages is directional guidance only. Final pricing depends on the clinical case, diagnostics, provider selection, and the confirmed treatment plan.",
          },
          {
            question:
              "What happens after I shortlist a procedure or treatment option?",
            answer:
              "The next step is to start your journey or request a consultation so Care N Tour can review the medical case, confirm suitability, and structure the most practical treatment pathway.",
          },
        ],
      },
      {
        ...
        heading:
          "Move from treatment research to a clearer next step with Care N Tour.",
        description:
          "Share your case and our team will help translate treatment options into a practical plan shaped around provider fit, travel timing, and recovery requirements.",
        layout: "split",
        background: "dark",
  ...
  },
  {
    ...
    name: "Doctors Page",
    description:
      "Marketing-focused doctors directory page with stronger Care N Tour voice, SEO framing, FAQ support, and conversion CTA.",
    defaultSlug: "doctors",
    ...
    blocks: [
      {
        ...
        eyebrow: "Our Doctors",
        heading:
          "Meet specialist doctors in Egypt trusted by Care N Tour for international patient journeys.",
        description:
          "At Care N Tour, we connect international patients with experienced doctors across leading specialties in Egypt. We help you identify the right specialist, understand your options, and move forward with clarity before you commit to treatment or travel.",
        backgroundImageUrl:
          "https://cmnwwchipysvwvijqjcu.supabase.co/storage/v1/object/public/media/cms/home-hero/90bc8c9d-bab8-45e6-9975-c7308001f4dd/cnt_hero.png",
        overlay: DEFAULT_HERO_OVERLAY,
        highlights: [
          {
            kicker: "Expertise",
            label:
              "Experienced doctors across high-demand medical, surgical, dental, and restorative specialties",
          },
          {
            kicker: "Guidance",
            label:
              "Care N Tour helps you compare specialists with your medical goals and travel plans in mind",
          },
          {
            kicker: "Support",
            label:
              "From doctor selection to case review and travel coordination, we stay with you at every step",
          },
        ],
        primaryAction: {
          label: "Start your journey",
      ...
      },
      {
        ...
        description:
          "We help patients choose doctors with more confidence by combining specialist access with coordination, clarity, and international patient support.",
        columns: 4,
        emphasizeValue: true,
        items: [
          {
            ...
            helper:
              "Doctors across major treatment areas for international patients seeking care in Egypt",
            icon: "Stethoscope",
          },
          {
            label: "Communication",
            value: "Multilingual",
            helper:
              "Language visibility helps patients and families feel more comfortable before consultation",
            icon: "Languages",
          },
          {
            ...
            helper:
              "Review experience, education, procedures, and profile details in one place",
            icon: "FileCheck",
          },
          {
            ...
            value: "Coordinated",
            helper:
              "Care N Tour connects doctor selection with treatment planning, travel, and follow-up support",
            icon: "Route",
          },
        ],
      },
      {
        ...
        heading:
          "We help you find the right doctor in Egypt, not just the next available name.",
        ...
        strengths: [
          {
            ...
            description:
              "We help you focus on doctors whose specialty and experience fit the treatment you are exploring.",
          },
          {
            title: "Clearer communication",
            description:
              "We make it easier to compare doctors by language and profile details before you move to consultation.",
          },
          {
            title: "Coordinated next steps",
            description:
              "Once you shortlist a doctor, we help with case review, planning, scheduling, and travel coordination.",
          },
        ],
        closing:
          "From the first shortlist to the final travel plan, Care N Tour helps make treatment in Egypt feel clearer, safer, and more personal.",
      },
      {
        ...
        description:
          "Browse doctors by specialty and language, review their profiles, and contact Care N Tour when you are ready to discuss your case, treatment options, and next steps.",
        trustCallout: {
          eyebrow: "International patient support",
          title: "We help you choose with more confidence",
          description:
            "When a doctor looks right for your case, Care N Tour helps you move from shortlisting to case review, treatment planning, and medical travel coordination in Egypt.",
        },
        ...
        states: {
          resultsIntro:
            "Browse our doctors to find the specialists most relevant to your treatment needs and preferred language.",
      ...
      },
      {
        ...
        description:
          "We answer the questions international patients ask most often before choosing a doctor and planning treatment in Egypt.",
        layout: "twoColumn",
        items: [
          {
            question:
              "How does Care N Tour help me choose the right doctor in Egypt?",
            answer:
              "We help you review the specialists most relevant to your treatment goals, compare their profiles, and understand the next step before you commit to treatment or travel. Our role is to make doctor selection clearer and more reassuring for international patients.",
          },
          {
            question: "Can Care N Tour help me choose a doctor?",
            answer:
              "Yes. If you are still exploring treatment options, Care N Tour can review your case, understand your goals, and help direct you toward the most relevant specialty or doctor in Egypt.",
          },
          {
            question:
              "What happens after I shortlist a doctor with Care N Tour?",
            answer:
              "After you shortlist a doctor, we can help collect medical records, coordinate case review, explain the likely treatment path, and connect that decision to consultation, travel planning, and on-ground support.",
          },
          {
            question:
              "Do I need to confirm treatment immediately after choosing a doctor?",
            answer:
              "No. Choosing a doctor is part of the evaluation process. Care N Tour helps you understand your options, timing, and likely next steps before any treatment schedule or travel commitment is finalized.",
          },
        ],
      },
      {
        ...
        heading:
          "Choose a doctor with confidence, then let Care N Tour guide everything that follows.",
        description:
          "Our team helps international patients move from doctor selection to case review, consultation planning, travel coordination, and treatment support in Egypt.",
        layout: "split",
        background: "dark",
        actions: [
          {
