  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        heading:
          "What international patients want to know about treatment in Egypt",
        description:
          "These answers explain how Care N Tour helps patients evaluate treatment options, understand likely timelines and costs, and plan care in Egypt with greater confidence.",
        layout: "twoColumn",
        items: [
          {
            question:
              "How does Care N Tour help me choose the right treatment pathway in Egypt?",
            answer:
              "Care N Tour helps patients understand their treatment options, coordinate specialist review, and narrow the most suitable pathway based on medical goals, recovery priorities, and travel considerations.",
          },
          {
            question:
              "What is included when I plan treatment through Care N Tour?",
            answer:
              "Depending on the case, Care N Tour can support specialist matching, provider coordination, preliminary treatment guidance, travel planning, accommodation support, and next-step coordination before arrival in Egypt.",
          },
          {
