      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            savings, and Egyptian hospitality with our comprehensive medical
            tourism services
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of patients who have chosen us for their medical
            journey. Get your free consultation and personalized treatment plan
            today.
          </p>
