...
const Hero = ({ backgroundImageUrl }: HeroProps) => {
  const resolvedBackgroundImageUrl =
    typeof backgroundImageUrl === "string" && backgroundImageUrl.trim().length
    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 hidden">
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start space-x-2 mb-2">
                <Star className="h-5 w-5 fill-current text-emphasis-on-brand" />
                <Star className="h-5 w-5 fill-current text-emphasis-on-brand" />
                <Star className="h-5 w-5 fill-current text-emphasis-on-brand" />
                <Star className="h-5 w-5 fill-current text-emphasis-on-brand" />
                <Star className="h-5 w-5 fill-current text-emphasis-on-brand" />
            ...
            <div className="text-center md:text-left">
              <Globe className="mx-auto mb-2 h-8 w-8 text-emphasis-on-brand md:mx-0" />
              <p className="text-3xl font-bold text-primary-foreground">50+</p>
              <p className="text-primary-foreground/80">Countries Served</p>
            </div>

            <div className="text-center md:text-left">
              <Shield className="mx-auto mb-2 h-8 w-8 text-emphasis-on-brand md:mx-0" />
      ...
      <div className="absolute bottom-10 right-10 hidden">
        <div className="bg-background/10 backdrop-blur-sm rounded-lg p-4 border border-background/20">
          ...
          <p className="text-2xl font-bold text-emphasis-on-brand">$2,500</p>
