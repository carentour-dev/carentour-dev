...
export function QuotationPrintView({
  ...
  const quoteQuery = useQuery({
    queryKey: [queryScope, "quotes", quoteId],
    queryFn: () =>
      adminFetch<OperationsQuoteDetail>(`${apiBasePath}/quotes/${quoteId}`),
...
export default function OperationsQuotationPrintView() {
  return <QuotationPrintView />;
}
