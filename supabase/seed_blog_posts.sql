-- Seed script to migrate existing static blog posts to the new blog system
-- This will create initial categories, an author, and migrate the 6 existing blog posts
