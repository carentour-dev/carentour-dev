-- Add rich content fields to treatments
ALTER TABLE public.treatments
  ADD COLUMN overview TEXT,
  ADD COLUMN ideal_candidates TEXT[] DEFAULT '{}'::TEXT[],
  ADD COLUMN procedures JSONB DEFAULT '[]'::jsonb;

-- Seed 20 rich treatments for testing
...
VALUES
  ...
  (
    ...
    'cardio-wellness-rehab-retreat',
    'cardiac-surgery',
    'Post-surgical cardiac rehabilitation with spa recovery.',
    'A four-week cardiology-led retreat combining monitored exercise, nutrition, and stress management for heart patients.',
    'International guests receive personalised rehab plans, telemetry suites, and lifestyle coaching in a resort setting.',
    4200, 'USD', 28, 14, 0,
    ARRAY[
      'Patients 4-6 weeks post cardiac surgery',
      'Individuals cleared for moderate exercise',
      'Travellers seeking supervised rehab abroad'
    ],
    '[
      {
        "name": "Monitored Cardiac Fitness Program",
        "description": "Daily telemetry-guided exercise, respiratory therapy, and cardiology consults.",
        "duration": "28 days",
        "recovery": "14 days",        
        "price": "$4,000 - $4,400",
        "egyptPrice": 4200,
        "success_rate": "Program dependent",
        "internationalPrices": [
          { "country": "United States", "flag": "🇺🇸", "price": 11800, "currency": "$" },
          { "country": "Germany", "flag": "🇩🇪", "price": 8400, "currency": "€" },
          { "country": "Saudi Arabia", "flag": "🇸🇦", "price": 9600, "currency": "﷼" }
        ],
        "candidateRequirements": [
          "Recent cardiology clearance",
          "Medication plan established",
          "Commitment to daily sessions"
        ],
        "recoveryStages": [
          { "stage": "Week 1", "description": "Baseline testing, nutrition planning, low-intensity exercise." },
          { "stage": "Week 2", "description": "Aerobic conditioning and stress management workshops." },
          { "stage": "Week 3", "description": "Strength training, lifestyle coaching." },
          { "stage": "Week 4", "description": "Discharge planning and remote monitoring setup." }
        ]
      }
    ]'::jsonb,
    TRUE
